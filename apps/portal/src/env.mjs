...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_TERMS_URL: z.string().url().or(z.literal('')).optional(),
    NEXT_PUBLIC_PRIVACY_URL: z.string().url().or(z.literal('')).optional(),
  },
  ...
  runtimeEnv: {
    ...
    AUTH_ENFORCED_PROVIDER: process.env.AUTH_ENFORCED_PROVIDER,
